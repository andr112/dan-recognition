    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(getContext()).inflate(
                    R.layout.item_detected, parent, false);
        }
        ...
        String name = Constants.getActivityString(getContext(), detectedActivity.getType());
        activityName.setText(name);
        String level = detectedActivity.getConfidence() + "%";
        activityConfidenceLevel.setText(level);
